...
$ git push`}
      ...
      >
        ...
        <motion.div
          ...
          className="relative mx-auto mb-10 sm:mb-14 w-40 h-40 sm:w-48 sm:h-48 md:w-60 md:h-60 flex items-center justify-center"
        >
          ...
          <div className="relative z-10 w-28 h-28 sm:w-36 sm:h-36 md:w-40 md:h-40 rounded-full overflow-hidden">
            <img
              src={profileImg}
              alt="Profile"
        ...
        {/* ROLE */}
        <p className="text-[10px] sm:text-xs md:text-sm uppercase tracking-[0.25em] sm:tracking-[0.3em] text-gray-300">
          MERN Stack Developer
        </p>

        {/* DESCRIPTION */}
        <p className="mt-4 sm:mt-5 text-xs md:text-sm text-gray-400 max-w-[90%] sm:max-w-sm md:max-w-xl mx-auto leading-relaxed">
